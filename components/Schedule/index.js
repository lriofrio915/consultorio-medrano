...
const Schedule = ({
  ...
  return (
    <div className={cn(styles.schedule, className)}>
      <div className={cn("title-red", styles.title)}>Agendar Cita</div>
      <div className={styles.note}>
        Selecciona la fecha y hora de tu próxima consulta.
      </div>
      ...
      <div className={styles.btns}>
        <button className={cn("button", styles.button)}>Confirmar</button>
      </div>
    </div>
  );
};
